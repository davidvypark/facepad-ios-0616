...
//            expect(coverCell.coverImage).to.beKindOf([UIImageView class]);
//            expect(coverCell.coverImage.image).to.equal(testUser.coverImage);
//        });
//    });
//    
...
//            expect(textCell.profile.image).to.equal(testUser.profilePicture);
//            expect(textCell.username.text).to.equal(testUser.username);
//        });
//        
